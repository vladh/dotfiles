...
set fo=cqt " don't continue comments on next line
...
" scroll up and down
"noremap <C-up> 3<C-y><CR>
"noremap <C-down> 3<C-e><CR>
...
" nyan
function! NyanMe() " {{{
    hi NyanFur             ctermfg=125
    hi NyanPoptartEdge     ctermfg=251
    hi NyanPoptartFrosting ctermfg=12	ctermbg=255
    hi NyanRainbow1        ctermfg=88
    hi NyanRainbow2        ctermfg=35
    hi NyanRainbow3        ctermfg=200
    hi NyanRainbow4        ctermfg=120
    hi NyanRainbow5        ctermfg=214
    hi NyanRainbow6        ctermfg=150
